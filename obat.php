        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="form-group">
                        <label>Nama</label>
                        <input name="nama" type="text" class="form-control" placeholder="Nama Obat .." autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Harga</label>
                        <input name="harga" type="text" class="form-control" placeholder="Harga Obat .." autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Stok</label>
                        <input name="stok" type="text" class="form-control" placeholder="Stok Obat .." autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="checkbox" name="khasiat[]" value="batuk"> Batuk <br>
                        <input type="checkbox" name="khasiat[]" value="flu"> Flu <br>
                        <input type="checkbox" name="khasiat[]" value="pusing"> Pusing <br>
                        <input type="checkbox" name="khasiat[]" value="sakit kepala"> Sakit Kepala <br>
                        <input type="checkbox" name="khasiat[]" value="mual"> Mual <br>
                        <input type="checkbox" name="khasiat[]" value="diare"> Diare <br>
                        <input type="checkbox" name="khasiat[]" value="masuk angin"> Masuk Angin <br>
                        <input type="checkbox" name="khasiat[]" value="maag"> Maag <br>
                        <input type="checkbox" name="khasiat[]" value="sakit perut"> Sakit Perut <br>
                        <input type="checkbox" name="khasiat[]" value="sakit badan"> Sakit Badan <br>
                        <input type="checkbox" name="khasiat[]" value="penenang"> Penenang <br>
                        <input type="checkbox" name="khasiat[]" value="panas"> Panas <br>
                        <input type="checkbox" name="khasiat[]" value="darah tinggi"> Darah Tinggi <br>
                        <input type="checkbox" name="khasiat[]" value="kolesterol"> Kolesterol <br>
                        <input type="checkbox" name="khasiat[]" value="diabetes"> Diabetes <br>
                        <input type="checkbox" name="khasiat[]" value="malaria"> Malaria
                    </div> 
                    <div class="form-group">
                        <label>Expired</label>
