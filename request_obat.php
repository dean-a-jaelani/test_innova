<?php 
    ...
    $data_obat = getData("SELECT * FROM request_obat ORDER BY id_request DESC");
    ...
    if (isset($_POST['submit'])){
        if (insert($_POST) > 0) {
            header("Location:request_obat.php");
        }else {
            echo "<script>alert('Ada yang salah!!!');</script>";
        }
    }
    // hitung jumlah record
    $sql = "SELECT count(*) AS jumlah FROM request_obat";
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Request Obat</a>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <?php } ?>
                                <?php if($_SESSION['level'] == 'admin') { ?>
                                <a href="print_request.php" target="_blank" class="btn btn-primary">Print</a> <?php } ?>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
                                    ...
                                    <?php foreach ($data_obat as $data) : ?>
                                        ...
                                        <?php if($_SESSION['level'] == 'apoteker') { ?>
                                            <td>
                                                <a href="update_request_obat.php?id=<?= $data['id_request'] ?>" class="btn btn-warning">Update</a>
                                                <a href="delete_request_obat.php?id=<?= $data['id_request'] ?>" class="btn btn-danger" onclick="return confirm('Anda yakin ingin menghapus data ini?');">Delete</a>
                                            </td>
                                        <?php } ?>
                                        </tr>
                                        <?php $i++; ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Request Obat Baru</h4>
            </div>
