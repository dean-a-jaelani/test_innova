		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Update Data Users</a>
                </div>
        ...
        <div class="content">
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?= $users['nama_lengkap'] ?>" name="nama_lengkap" type="text" class="form-control" placeholder="Nama Lengkap .." autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Username</label>
                        <input value="<?= $users['username'] ?>" name="username" type="text" class="form-control" placeholder="Username .." autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Password</label>
                        <input value="<?= $users['password'] ?>" name="password" type="password" class="form-control" placeholder="Password .." autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label>Level</label>
