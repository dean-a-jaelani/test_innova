<?php 
    ...
    $id = $_GET['id'];
    $obat = getData("SELECT * FROM request_obat WHERE id_request = $id")[0];
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Update Request Obat</a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <form action="" method="post">
                            <input type="hidden" name="id" value="<?= $obat['id_request'] ?>">
